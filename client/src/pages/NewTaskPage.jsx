...
export default function NewTaskPage({ isGroupTask }) {
  ...
  function handleTypeChange(event) {
    // changes between daily and to-do related input panels
  ...
  return (
    <Form
      method="POST"
      className="bg-white rounded-lg p-16 flex flex-col items-stretch gap-16"
    >
